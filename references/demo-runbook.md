...
Use this runbook for the workshop case "From zero to launch: your AI e-commerce partner".
...
"平台账号和发布规范会变化，所以培训中重点展示发布前准备。我们要让用户看到标题、正文、图片顺序、话题标签和发布前确认清单已经完整准备好。"

Customer service transition:

"发布之后不是结束，用户开始提问。AI 会基于 FAQ 秒回，同时判断买家是在比价、担心质量，还是准备下单。"

Loopback close:

"最后评论分析会反向修正选品假设。也就是说，今天的用户反馈，会变成下一轮选品的输入条件。"
