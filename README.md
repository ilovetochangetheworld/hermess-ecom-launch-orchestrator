...
4. 图片 Prompt 与素材准备：基于真实商品图、供应商图或商品截图，整理封面图、功能图、场景图的顺序、补图清单和生成 Prompt。
...
| 图片 Prompt 与素材准备 | 真实商品图、供应商图、商品截图或商品画像 | 封面/功能/场景图片顺序、补图清单和图片 Prompt |
...
图片 Prompt 与商品图片素材（image_pack 字段或图片文件）
