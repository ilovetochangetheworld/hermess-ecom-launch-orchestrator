...
5. 发布准备包：输出标题、正文、话题、图片顺序和发布前确认清单。
6. 智能客服 FAQ：生成常见问题、买家意图识别和回复样例。
7. 评论复盘闭环：把评论痛点和运营数据回流成下一轮选品建议。

当前版本聚焦发布前准备。Agent 会整理好发布准备包，最终发布由讲师或运营人员按账号状态和平台规范确认。
...
注意：
- 本次演示聚焦发布前准备，最终发布由讲师或运营人员按平台规范确认。
...
| 6:15-7:15 | 发布准备包 | 标题、正文、图片顺序、发布前确认清单 |
